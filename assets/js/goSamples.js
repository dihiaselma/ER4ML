  ...
  <div id="sidebar" class="sidebar-nav" style="width:250px; height:600px; font-family:cambria">\
    ...
    <form style="display:block; width:400px ; ">\
     <label for="work_abroad"></label>\
  		...
  		<input type="radio" name="rad" value="Denormalization" style="margin-left:2em;"> Denormalization<br>\
      <input type="radio" name="rad" value="Dataset" style="margin-left:2em;"> Dataset \
	</form>\
  </div>\
	<br>\
    ...
    <tr>\
    <th style="font-family:cambria; font-size:12px;">Primary keys</th>\
    <th style="font-family:cambria; font-size:12px;">Foreign keys</th>\
    <th style="font-family:cambria; font-size:12px;">Columns</th>\
    </tr>\
    <tr>\
    <th><textarea id="myTextareaKeys" name="message" style="width:80px; height:100px; color:black; font-family:cambria; font-size:10px; border: 1px solid black;">\
      Put key columns of the transformed table here (column/line)...\
    </textarea></th>\
    <th><textarea id="myTextareaFK" name="message" style="width:80px; height:100px; color:black; font-family:cambria; font-size:10px; border: 1px solid black;">\
      Put Foreign key columns of the transformed table here (column/line)...\
    </textarea></th>\
    <th><textarea id="myTextarea" name="message" style="width:80px; height:100px; color:black; font-family:cambria; font-size:10px; border: 1px solid black;">\
    ...
    \
    \
    <div id="div1" style="width:320px; height:50px;"></div>\
    <br>\
