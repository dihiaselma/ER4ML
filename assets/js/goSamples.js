...
var mySampleMenu = '\
  <div id="sidebar" class="sidebar-nav" style="width:250px; height:600px; font-family:cambria">\
    ...
    <tr>\
    <th><textarea id="myTextareaKeys" name="message" style="width:90px; height:150px; color:black; font-family:cambria; font-size:10px; border: 1px solid black;">\
      Put key columns of the transformed table here (column/line)...\
    </textarea></th>\
    <th><textarea id="myTextareaFK" name="message" style="width:90px; height:150px; color:black; font-family:cambria; font-size:10px; border: 1px solid black;">\
      Put Foreign key columns of the transformed table here (column/line)...\
    </textarea></th>\
    <th><textarea id="myTextarea" name="message" style="width:90px; height:150px; color:black; font-family:cambria; font-size:10px; border: 1px solid black;">\
    ...
    \
    \
    <textarea id="myQuery" name="comment" style="width:270px; height:50px; color:black; font-family:cambria; border: 2px solid black;">\
      Put your query here...\
    </textarea>\
    <br>\
    <br>\
